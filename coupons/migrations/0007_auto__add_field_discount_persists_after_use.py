...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discount.persists_after_use'
        db.add_column('coupons_discount', 'persists_after_use',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discount.persists_after_use'
        db.delete_column('coupons_discount', 'persists_after_use')
