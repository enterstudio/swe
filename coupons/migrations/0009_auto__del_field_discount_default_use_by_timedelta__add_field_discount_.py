...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discount.default_use_by_days'
        db.add_column('coupons_discount', 'default_use_by_days',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Discount.default_use_by_days'
        db.delete_column('coupons_discount', 'default_use_by_days')
