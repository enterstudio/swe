...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discount.expiration_date'
        db.alter_column('coupons_discount', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Discount.expiration_date'
        db.alter_column('coupons_discount', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        'coupons.discount': {
            ...
            'default_use_by_days': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'persists_after_use': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'coupons.featureddiscount': {
            ...
            'promotional_text': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'coupons.referral': {
