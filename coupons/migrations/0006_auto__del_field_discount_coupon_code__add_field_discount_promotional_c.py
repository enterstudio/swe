...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Discount.coupon_code'
        db.delete_column('coupons_discount', 'coupon_code')

        # Adding field 'Discount.promotional_code'
        db.add_column('coupons_discount', 'promotional_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Discount.coupon_code'
        db.add_column('coupons_discount', 'coupon_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Discount.promotional_code'
        db.delete_column('coupons_discount', 'promotional_code')
