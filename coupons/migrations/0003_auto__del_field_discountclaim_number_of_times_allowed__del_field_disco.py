...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DiscountClaim.number_of_times_allowed'
        db.delete_column('coupons_discountclaim', 'number_of_times_allowed')

        # Deleting field 'DiscountClaim.number_of_times_used'
        db.delete_column('coupons_discountclaim', 'number_of_times_used')
    ...
    def backwards(self, orm):
        # Adding field 'DiscountClaim.number_of_times_allowed'
        db.add_column('coupons_discountclaim', 'number_of_times_allowed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DiscountClaim.number_of_times_used'
        db.add_column('coupons_discountclaim', 'number_of_times_used',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
