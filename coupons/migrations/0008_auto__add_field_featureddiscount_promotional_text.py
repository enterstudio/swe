...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedDiscount.promotional_text'
        db.add_column('coupons_featureddiscount', 'promotional_text',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeaturedDiscount.promotional_text'
        db.delete_column('coupons_featureddiscount', 'promotional_text')
