...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.datetime_uploaded'
        db.alter_column('swe_document', 'datetime_uploaded', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.datetime_uploaded'
        db.alter_column('swe_document', 'datetime_uploaded', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        'swe.document': {
            ...
            'datetime_uploaded': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
